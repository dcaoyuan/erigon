...
func newKeccak256Op(sn uint16, input []byte, output []byte) *keccak256Op {
	...
	return &keccak256Op{
		baseOp{sn, vm.KECCAK256},
		inputCopy,
		outputCopy,
	}
}

func newSstoreOp(sn uint16, offset [32]byte, oldVal [32]byte, newVal [32]byte) *sstoreOp {
...
type callFrame struct {
	...
	Sn       uint16            `json:"sn,omitempty" rlp:"optional"`
