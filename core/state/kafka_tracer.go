...
func NewKafkaTracer(block *types.Block) *kafkaTracer {
	once.Do(func() {
		kafkaWriter = &kafka.Writer{
			...
			Topic:        KAFKA_TOPIC,
			BatchSize:    1,        // interval between 2 block messages is 10+ seconds, batch size 1 is enough
			BatchBytes:   20971520, // kafka-go should set this explicitly here to allow large message.
